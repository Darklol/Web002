...
<%-- Draw axis --%>
        ...
        <%-- Draw two triangles in the positive direction of the x and y axes --%>
        ...
        <%--<line> is the tick mark,<text> is for the scale--%>
        <%--On X axis--%>
